...
% 3. Вычисление значений полинома Ньютона в узлах «непрерывной» ВС

z=Newton2(tk,xk,t);

% 4. Построение разности между точным и интерполированными значениями функции   (рис. 2.9)
...
SER_4=10*log10(sigPower/errorPower)
