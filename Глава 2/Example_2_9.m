...
% 3. Вычисление значений полинома Эверетта в узлах заданной координатной сетки

>> for i=1:length(t)
>> z(i)= Everett_interp(tk,xk,t(i));
>> end

% 4. Построение разности между точным и интерполированными значениями функции   (рис. 2.16)
...
>> SER_9=10*log10(sigPower/errorPower) 
