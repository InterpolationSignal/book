...
% 3. Вычисление значений второго полинома Гаусса в узлах заданной координатной сетки

z=Gauss_interp2(tk,xk,t); % вычисление значений ДС 
                          % интерполированных 
                          % с помощью полинома Гаусса


% 4. Построение разности между точным и интерполированными значениями функции   (рис. 2.13)
...
>> SER_6=10*log10(sigPower/errorPower)
