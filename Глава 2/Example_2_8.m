...
% 3. Вычисление значений полинома Бесселя в узлах заданной координатной сетки

>> z=Bessel_interp(tk,xk,t);

% 4. Построение разности между точным и интерполированными значениями функции   (рис. 2.15)
...
SER_8=10*log10(sigPower/errorPower)
